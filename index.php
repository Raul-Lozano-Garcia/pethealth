    ...
    <main>
        ...
        <section id="testimonio">
            ...
            <?php  
                ...
                $consulta_testimonio="SELECT nombre,contenido FROM testimonio INNER JOIN dueño ON dni_autor=dni ORDER BY RAND() LIMIT 1";
                ...
                if($filas_devueltas===0){
                    ...
                    while($fila_testimonio=$datos_testimonio->fetch_array(MYSQLI_ASSOC)){
                        echo "<h3>$fila_testimonio[nombre]</h3>
                              <p>"; echo nl2br("$fila_testimonio[contenido]"); echo "</p>";  
                    } 
                }       
            ?>
        </section>
